<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="extract.aspx.cs" Inherits="WebCompression.extract" %>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<h1 class="brand-heading">Extract</h1>
				<p class="intro-text">
					Extract your original data here
				</p>
				<a href="#upload-extract" class="btn btn-circle page-scroll">
